...
import (
	...
	falconcontroller "github.com/crowdstrike/falcon-operator/internal/controller/falcon"
...
func main() {
	...
	if err = (&falconcontroller.FalconContainerReconciler{
	...
	if err = (&falconcontroller.FalconNodeSensorReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
	...
	if err = (&falconcontroller.FalconAdmissionReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
	...
	if err = (&falconcontroller.FalconImageAnalyzerReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
	...
	if err = (&falconcontroller.FalconDeploymentReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
