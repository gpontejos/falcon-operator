...
### FalconDeployment CR Configuration using CrowdStrike API Keys
...
### FalconDeployment Reference Manual
...
#### FalconDeployment Registry Settings
| Spec                                 | Description                                                                                              |
| :----------------------------------- | :------------------------------------------------------------------------------------------------------- |
...
#### FalconDeployment Configuration Settings
...
### Install Steps
To install Falcon Admission Controller, run the following command to install the FalconDeployment CR:
```sh
...
### Uninstall Steps
To uninstall FalconDeployment simply remove the FalconDeployment resource. The operator will uninstall the FalconDeployment resource and any CRs deployed from the cluster.

```sh
oc delete falcondeployment --all
``` 
...
- You can get more insight by viewing the FalconDeployment CRD in full detail by running the following command:

  ```sh
  oc get falcondeployment -o yaml
  ```
